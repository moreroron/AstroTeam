...
const Navbar = () => {
  ...
  const links = isLoggedIn ? (
    <>
      <NavLink to="/dashboard" className="navbar-item" activeClassName="activeLink">
        Dashboard
      </NavLink>
      <NavLink to="/chat" className="navbar-item" activeClassName="activeLink">
        Chat
      </NavLink>
      <NavLink to="/map" className="navbar-item" activeClassName="activeLink">
        Map
      </NavLink>
      <NavLink to="/about" className="navbar-item" activeClassName="activeLink">
        About
      </NavLink>
    </>
  ) : (
    ...
    <nav className="navbar is-fullheight-with-navbar" role="navigation" aria-label="main navigation">
      <div className="container navbar-menu">
        <div className="navbar-start">
          <Link to="/" className="navbar-item m-r-lg">
            <i className="fas fa-user-astronaut logo"></i>
          </Link>
          {links}
        </div>
        ...
        <div className="navbar-end">
          <div className="navbar-item">
            <div className="level">{navOnline}</div>
          </div>
        </div>
      </div>
    </nav>
