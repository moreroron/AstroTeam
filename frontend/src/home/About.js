                        ...
                        <div className="column is-3 is-offset-2">
                            <aside className="menu">
                                ...
                                <ul className="menu-list">
                                    <li><NavLink to='/about/summary' activeClassName="is-active">Summary</NavLink></li>
                                    <li><NavLink to='/about/statistics' activeClassName="is-active">Statistics</NavLink></li>
                                    <li><NavLink to='/about/video' activeClassName="is-active">Video</NavLink></li>
                                </ul>
                            </aside>
                        </div>
                    </div>
